    ...
    async def is_available(self) -> bool:
        ...
        try:
            ...
            process = await asyncio.create_subprocess_exec(
                "orb", "version", stdout=subprocess.PIPE, stderr=subprocess.PIPE
            )
            ...
            if process.returncode == 0:
                ...
                logger.debug(
                    f"OrbStack not available, return code: {process.returncode}"
                )
                return False
    ...
    async def get_server_info(
        ...
        try:
            ...
            if process.returncode != 0:
                ...
                return {"status": "unknown", "error": stderr.decode(), **context}
