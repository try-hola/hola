...
import pytest
from hola_cli.test_utils.fakes.provider_registry import FakeProviderRegistry, FakeProvider
...
def test_fake_provider_registry_get_available_providers():
    ...
    registry.providers["unavailable_test"] = TestUnavailableProvider(provider_type="unavailable_test")
