...
def fake_hello_context():
    ...
    context.client.register_response(
        "/hello", 
        {"name": "Test"}, 
        ApiResponse(success=True, data="Hello, Test!")
    )
    return context
...
class TestHelloCommands:
    ...
    def test_hello_greet_command(self, mock_hello_service, mock_get_server, cli_runner, fake_hello_context):
        """
        ...
        mock_service_instance.hello.return_value = ApiResponse(success=True, data="Hello, World!")
    ...
    @patch("hola_cli.commands.hello.get_current_server")
    @patch("hola_cli.commands.hello.HelloService")
    def test_hello_greet_with_name(self, mock_hello_service, mock_get_server, cli_runner, fake_hello_context):
        """
        ...
        mock_get_server.return_value = fake_hello_context
        mock_service_instance = mock_hello_service.return_value
        mock_service_instance.hello.return_value = ApiResponse(success=True, data="Hello, Test!")
    ...
    @patch("hola_cli.commands.hello.get_current_server")
    @patch("hola_cli.commands.hello.HelloService")
    def test_hello_greet_json_format(self, mock_hello_service, mock_get_server, cli_runner, fake_hello_context):
        """
    ...
    @patch("hola_cli.commands.hello.get_current_server")
    @patch("hola_cli.commands.hello.HelloService")
    def test_hello_greet_api_error(self, mock_hello_service, mock_get_server, cli_runner):
        """
