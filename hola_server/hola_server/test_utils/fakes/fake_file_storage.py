...
class FakeFileStorage:
    ...
    async def delete_file(self, app_name: str, file_path: str) -> bool:
        ...
        if self._should_fail("file_delete"): # Check for forced failure (key is "file_delete" in test)
            from hola_shared.errors import ValidationException # Add import
            raise ValidationException("Forced file deletion failure in fake for testing")
