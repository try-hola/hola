...
from hola_shared.models.config import ConfigCreateRequest, ConfigUpdateRequest
...
class TestFakeConfigService:
    ...
    async def test_method_calls_tracking(self, fake_config_service):
        ...
        list_call = next(
            call for call in calls if call["method"] == "list_config_entries"
        )
    ...
    async def test_create_and_retrieve_config_entry(self, fake_config_service):
        ...
        response = await fake_config_service.create_config_entry(
    ...
    async def test_update_config_entry(self, fake_config_service):
        ...
        # Create entry
        create_request = ConfigCreateRequest(
            key=key, value="original", description="Original", is_secret=False
        )
        await fake_config_service.create_config_entry(app_name, create_request)

        # Update entry
        update_request = ConfigUpdateRequest(
            value="updated", description="Updated", is_secret=True
        )
        response = await fake_config_service.update_config_entry(
    ...
    async def test_delete_config_entry(self, fake_config_service):
        ...
        # Create entry
        create_request = ConfigCreateRequest(
            key=key, value="value", description=None, is_secret=False
        )
        await fake_config_service.create_config_entry(app_name, create_request)
    ...
    async def test_delete_app_config(self, fake_config_service):
        ...
        for i in range(3):
            request = ConfigCreateRequest(
                key=f"key{i}", value=f"value{i}", description=None, is_secret=False
            )
    ...
    async def test_list_config_entries(self, fake_config_service):
        ...
        entries = [
            ConfigCreateRequest(
                key="key1", value="value1", description=None, is_secret=False
            ),
            ConfigCreateRequest(
                key="key2", value="value2", description=None, is_secret=False
            ),
            ConfigCreateRequest(
                key="key3", value="value3", description=None, is_secret=False
            ),
        ]
    ...
    async def test_validation_errors(self, fake_config_service):
        ...
        # Empty key
        request = ConfigCreateRequest(
            key="", value="value", description=None, is_secret=False
        )
        with pytest.raises(
    ...
    async def test_not_found_errors(self, fake_config_service):
        ...
        update_request = ConfigUpdateRequest(
            value="value", description=None, is_secret=False
        )
    ...
    async def test_duplicate_key_error(self, fake_config_service):
        ...
        # Create entry
        request = ConfigCreateRequest(
            key=key, value="value1", description=None, is_secret=False
        )
        await fake_config_service.create_config_entry(app_name, request)

        # Try to create duplicate
        duplicate_request = ConfigCreateRequest(
            key=key, value="value2", description=None, is_secret=False
        )
        with pytest.raises(
            ValidationException, match=f"Configuration entry '{key}' already exists"
        ):
    ...
    async def test_preserves_timestamps_on_update(self, fake_config_service):
        ...
        # Create entry
        create_request = ConfigCreateRequest(
            key=key, value="original", description=None, is_secret=False
        )
        create_response = await fake_config_service.create_config_entry(
            app_name, create_request
        )
        ...
        update_request = ConfigUpdateRequest(
            value="updated", description=None, is_secret=False
        )
        update_response = await fake_config_service.update_config_entry(
            app_name, key, update_request
        )
