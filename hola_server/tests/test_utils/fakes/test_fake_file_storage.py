...
class TestFakeFileStorage:
    ...
    async def test_list_files_empty(self, fake_file_storage):
        ...
        assert fake_file_storage.was_method_called_with("list_files", app_name="new-app")
    ...
    async def test_list_files_with_files(self, populated_file_storage):
        ...
        assert file_list.total_size_bytes == len(b"File 1 content") + len(b"File 2 content is longer")
    ...
    async def test_upload_file_overwrite(self, populated_file_storage):
        ...
        assert populated_file_storage.get_file_content("app1", "file1.txt") == new_content
