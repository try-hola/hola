...
class TestMetricsService:
    ...
    def create_test_metric(self, name: str = "cpu_usage", value: float = 75.5, timestamp: Optional[datetime] = None) -> MetricRecordRequest:
    ...
    async def test_get_metrics_with_data(self, metrics_service):
        ...
        await metrics_service.record_metric(app_name, self.create_test_metric("cpu_usage", 75.5, now))
        await metrics_service.record_metric(app_name, self.create_test_metric("memory_usage", 45.2, now))
        await metrics_service.record_metric(app_name, self.create_test_metric("cpu_usage", 80.1, now + timedelta(minutes=1)))
    ...
    async def test_get_metrics_with_name_filter(self, metrics_service):
        ...
        # Add metrics with different names
        await metrics_service.record_metric(app_name, self.create_test_metric("cpu_usage", 75.5))
        await metrics_service.record_metric(app_name, self.create_test_metric("memory_usage", 45.2))
        await metrics_service.record_metric(app_name, self.create_test_metric("disk_usage", 30.1))
    ...
    async def test_get_metrics_with_time_filter(self, metrics_service):
        ...
        await metrics_service.record_metric(app_name, self.create_test_metric("cpu_usage", 75.5, now - timedelta(hours=2)))
        await metrics_service.record_metric(app_name, self.create_test_metric("cpu_usage", 80.1, now - timedelta(minutes=30)))
        await metrics_service.record_metric(app_name, self.create_test_metric("cpu_usage", 85.2, now))
    ...
    async def test_get_metrics_with_limit(self, metrics_service):
        ...
        for i in range(10):
            await metrics_service.record_metric(app_name, self.create_test_metric("cpu_usage", float(i * 10)))
    ...
    async def test_get_metrics_summary(self, metrics_service):
        ...
        # Add memory metrics
        await metrics_service.record_metric(app_name, self.create_test_metric("memory_usage", 1024.0))
        await metrics_service.record_metric(app_name, self.create_test_metric("memory_usage", 2048.0))
...
class TestFakeMetricsService:
    ...
    def create_test_metric(self, name: str = "cpu_usage", value: float = 75.5) -> MetricRecordRequest:
        """Create a test metric request."""
        return MetricRecordRequest(
            name=name,
            value=value,
    ...
    async def test_get_metrics_with_filters(self, fake_service):
        ...
        # Add metrics
        await fake_service.record_metric("test-app", self.create_test_metric("cpu_usage", 75.5))
        await fake_service.record_metric("test-app", self.create_test_metric("memory_usage", 45.2))
    ...
    async def test_clear_metrics(self, fake_service):
        ...
        # Add some metrics
        for i in range(3):
            await fake_service.record_metric("test-app", self.create_test_metric(value=float(i * 10)))
