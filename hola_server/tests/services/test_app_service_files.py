...
from hola_server.services.app_service import AppService
...
class TestAppServiceFiles:
    ...
    async def test_list_app_files(self, app_service):
        ...
        await app_service.file_storage.upload_file("test-app", "file1.txt", b"content1", "text/plain")
        await app_service.file_storage.upload_file("test-app", "file2.txt", b"content2", "text/plain")
    ...
    async def test_upload_app_file_with_path(self, app_service):
        ...
        file_info = await app_service.upload_app_file("test-app", test_file, path="subfolder/renamed.txt")
    ...
    async def test_get_app_file(self, app_service):
        ...
        # Upload a file first
        await app_service.file_storage.upload_file("test-app", "test.txt", b"test file content", "text/plain")
