...
from hola_shared.models.config import (
    ...
    ConfigListResponse, ConfigEntryResponse, ConfigEntry, AppConfig
)
...
class TestConfigService:
    ...
    @pytest.mark.asyncio
    async def test_get_app_config_creates_empty_config_for_new_app(self, config_service):
    ...
    async def test_list_config_entries_returns_all_entries(self, config_service):
        ...
        entries = [
            ConfigCreateRequest(key="key1", value="value1", description="First config", is_secret=False),
            ConfigCreateRequest(key="key2", value="value2", description="Second config", is_secret=False),
            ConfigCreateRequest(key="key3", value="value3", description="Third config", is_secret=True)
        ]
    ...
    @pytest.mark.asyncio
    async def test_get_config_entry_raises_not_found_for_missing_entry(self, config_service):
    ...
    @pytest.mark.asyncio
    async def test_create_config_entry_raises_error_for_duplicate_key(self, config_service):
        ...
        with pytest.raises(ValidationException, match=f"Configuration entry '{key}' already exists for app '{app_name}'"):
            await config_service.create_config_entry(app_name, create_request)
    ...
    async def test_create_config_entry_validates_parameters(self, config_service):
        ...
        with pytest.raises(ValidationException, match="App name cannot be empty"):
            create_request = ConfigCreateRequest(key="key", value="value", description="desc", is_secret=False)
    ...
    async def test_update_config_entry_updates_existing_entry(self, config_service):
        ...
        updated_response = await config_service.update_config_entry(app_name, key, update_request)
    ...
    @pytest.mark.asyncio
    async def test_update_config_entry_preserves_description_when_not_provided(self, config_service):
    ...
    @pytest.mark.asyncio
    async def test_update_config_entry_raises_not_found_for_missing_entry(self, config_service):
    ...
    @pytest.mark.asyncio
    async def test_delete_config_entry_raises_not_found_for_missing_entry(self, config_service):
