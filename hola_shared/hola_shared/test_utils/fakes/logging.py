...
class FakeLogger:
    ...
    def get_messages(self, level: Optional[str] = None) -> List[LogMessage]:
        ...
        if level:
            ...
            if isinstance(level_int, str): # getLevelName returns level string if not found
    ...
    def record_tuples(self) -> List[tuple[str, int, str]]:
        ...
        return [(self.name, msg.level, msg.message % msg.args if msg.args else msg.message) for msg in self.messages]
