...
class HealthCheckResult(BaseModel):
    ...
    duration_ms: Optional[float] = Field(None, description="Health check duration in milliseconds")
...
class HealthStatus(BaseModel):
    ...
    checks: Dict[str, HealthCheckResult] = Field(default_factory=dict, description="Individual health check results")
...
class ServerStatus(BaseModel):
    ...
    status_checked_at: datetime = Field(..., description="When this status was generated")
