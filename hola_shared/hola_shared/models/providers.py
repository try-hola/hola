...
class ProviderInfo(BaseModel):
    ...
    available: bool = Field(..., description="Whether the provider is available on the current system")
...
class ServerContext(BaseModel):
    ...
    started_at: Optional[str] = Field(None, description="Timestamp when the server was started")
