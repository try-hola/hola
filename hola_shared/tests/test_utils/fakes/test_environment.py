...
def test_fake_environment_context_manager():
    ...
    try:
        with FakeEnvironment(initial_vars=fake_initial_vars) as fake_env_ctx:
            ...
            assert "PRESERVED_OS_VAR" not in os.environ # It was cleared and not in fake_initial_vars
            ...
            assert "NEW_INSIDE_CTX" not in fake_env_ctx.vars # As per current implementation
        ...
        assert "NEW_INSIDE_CTX" not in os.environ # Changes made to os.environ inside are gone
