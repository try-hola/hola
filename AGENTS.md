...
- Commit messages end with: `Co-Authored-By: Codex Opus 4.8 (1M context) <noreply@anthropic.com>`
- PR bodies end with: `🤖 Generated with [Codex](https://Codex.com/Codex)`
...
- **Full e2e (CLI + browser)** — the **`vm-e2e` skill** (`.Codex/skills/vm-e2e/`)
