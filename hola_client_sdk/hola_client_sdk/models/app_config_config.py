...
T = TypeVar("T", bound="AppConfigConfig")
...
class AppConfigConfig:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        app_config_config = cls()

        additional_properties = {}
        for prop_name, prop_dict in d.items():
            additional_property = ConfigEntry.from_dict(prop_dict)

            additional_properties[prop_name] = additional_property

        app_config_config.additional_properties = additional_properties
        return app_config_config
