...
T = TypeVar("T", bound="ApiResponseFileInfo")


@_attrs_define
class ApiResponseFileInfo:
    """
    Attributes:
        success (bool):
        data (Union['FileInfo', None, Unset]):
        error (Union['ApiError', None, Unset]):
    """

    success: bool
    data: Union["FileInfo", None, Unset] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> Union["FileInfo", None, Unset]:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(Union["FileInfo", None, Unset], data)
        ...
        api_response_file_info = cls(
            success=success,
            data=data,
            error=error,
        )

        api_response_file_info.additional_properties = d
        return api_response_file_info
