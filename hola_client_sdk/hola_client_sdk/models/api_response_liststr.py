...
T = TypeVar("T", bound="ApiResponseListstr")
...
class ApiResponseListstr:
    ...
    Attributes:
        success (bool):
        data (Union[None, Unset, list[str]]):
        error (Union['ApiError', None, Unset]):
    """

    success: bool
    data: Union[None, Unset, list[str]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> Union[None, Unset, list[str]]:
            if data is None:
                return data
        ...
        api_response_liststr = cls(
            success=success,
            data=data,
            error=error,
        )

        api_response_liststr.additional_properties = d
        return api_response_liststr
