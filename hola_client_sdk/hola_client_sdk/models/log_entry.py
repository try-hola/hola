...
if TYPE_CHECKING:
    from ..models.log_entry_context import LogEntryContext
...
class LogEntry:
    ...
    Attributes:
        ...
        timestamp (datetime.datetime): Log entry timestamp
        level (LogLevel): Log level enumeration.
        source (LogSource): Log source enumeration.
        message (str): Log message content
        app_name (Union[None, Unset, str]): Associated application name
        context (Union[Unset, LogEntryContext]): Additional context data
    ...
    context: Union[Unset, "LogEntryContext"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        context: Union[Unset, LogEntryContext]
        if isinstance(_context, Unset):
            context = UNSET
        else:
            context = LogEntryContext.from_dict(_context)
