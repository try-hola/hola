...
T = TypeVar("T", bound="ApiResponseApp")
...
class ApiResponseApp:
    ...
    Attributes:
        success (bool):
        data (Union['App', None, Unset]):
        error (Union['ApiError', None, Unset]):
    """

    success: bool
    data: Union["App", None, Unset] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> Union["App", None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                data_type_0 = App.from_dict(data)

                return data_type_0
            except:  # noqa: E722
                pass
            return cast(Union["App", None, Unset], data)
        ...
        api_response_app = cls(
            success=success,
            data=data,
            error=error,
        )

        api_response_app.additional_properties = d
        return api_response_app
