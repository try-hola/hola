...
from ...models.api_response_app import ApiResponseApp
...
) -> Optional[Union[ApiResponseApp, HTTPValidationError]]:
    if response.status_code == 200:
        response_200 = ApiResponseApp.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ApiResponseApp, HTTPValidationError]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ApiResponseApp, HTTPValidationError]
    """
