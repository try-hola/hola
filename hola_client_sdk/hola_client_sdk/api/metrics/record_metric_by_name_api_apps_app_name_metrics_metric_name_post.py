...
from ...models.record_metric_by_name_api_apps_app_name_metrics_metric_name_post_metric_request import (
...
def _get_kwargs(
    ...
    metric_name: str,
    *,
    body: RecordMetricByNameApiAppsAppNameMetricsMetricNamePostMetricRequest,
) -> dict[str, Any]:
