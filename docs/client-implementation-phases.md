...
- Basic CLI framework using Commander.js
- Configuration storage in `~/.hola/config.json`
...
- Full application lifecycle commands:
  - `hola app deploy`
  - `hola app upgrade`
  - `hola app delete`
  - `hola app start/stop/restart`
- File upload capabilities:
  - `hola file upload/list/delete`
- Progress indicators for long-running operations
- Improved error handling with specific guidance
- Enhanced output formatting (table, JSON)
...
- Output formatting with table and JSON support
